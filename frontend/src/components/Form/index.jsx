...
function Form({titleInput,setTitle,descriptionInput,setDescription}){
                ...
                <div class="overlay">
                    <div class="modal-content">
                        ...
                        <div class="modal-search-bar">
                            <input type="text" class="search-input" value={titleInput} onChange={(e)=>setTitle(e.target.value)}></input>
                        </div>
                        <h3>Description</h3>
                        <div class="modal-search-bar">
                            <input type="text" class="search-input" value={descriptionInput} onChange={(e)=>setDescription(e.target.value)}></input>
                        </div>
